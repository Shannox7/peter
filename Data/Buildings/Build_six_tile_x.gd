...
func placeable():
	if obstructions == [] and get_node("RayCast2D").is_colliding() and get_node("RayCast2D1").is_colliding() and get_node("RayCast2D2").is_colliding()  and get_node("RayCast2D3").is_colliding() and get_node("RayCast2D4").is_colliding() and get_node("RayCast2D5").is_colliding() and defence_zone != []:
